...
<style>
	...
	#sub-menu {border:1px solid black; padding:5px; }
...
<c:choose>
	...
	<div class="wrap">
			<table style="width: 100%; margin-top: 10px; border:1px solid black; height:75px;" align="center">
				<tr align="center">	
					<td>
						<b style="font-size:15px; color:gray">회원님의 등급은 <font color="orange">${sessionScope.grade}</font>입니다.</b>
					</td> 
					<td>
...
<script>
	...
	function popupOpen() { window.open("/seller/popup_grade.j", "회원 등급 팝업창", "width=400, height=300, left=100, top=50, scrollbars= 0, toolbar=0, menubar=no"); }
</script>